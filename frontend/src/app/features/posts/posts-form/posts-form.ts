...
@Component({
  ...
  imports: [MatCardModule, MatInputModule, MatIconModule, ReactiveFormsModule, CommonModule, MatChipsModule, MatOptionModule, MatButtonModule, MatSelectModule],
...
export class PostsForm {
  ...
  addTag(tag: string) {
    ...
    tagsArray.push(new FormControl(tag, [Validators.required, Validators.minLength(1), Validators.maxLength(50)]));
  }
